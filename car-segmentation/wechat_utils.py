...
class SendMessage(Callback):
    ...
    def decrease_lr(self):
        ...
        self.t_send('learning rate decrease to {} from next batch'.format(lr / 10), 
...
#==============================================================================
        def manualstop(msg):
            ...
            lr_list=['Decrease lr', 'Decrease learning rate']
            if msg['ToUserName']=='filehelper':
                print('\n',text,'\n')
                if any((k in text) for k in lr_list):
                    # decreae lr after bathe end
                    self.flag_decrease_lr = True
                if 'Stop at' in text:
